...
public class OAuth2ScopeGrantPersistenceImpl extends BasePersistenceImpl<OAuth2ScopeGrant>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_T = new FinderPath(OAuth2ScopeGrantModelImpl.ENTITY_CACHE_ENABLED,
			OAuth2ScopeGrantModelImpl.FINDER_CACHE_ENABLED,
			OAuth2ScopeGrantImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByT",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_T = new FinderPath(OAuth2ScopeGrantModelImpl.ENTITY_CACHE_ENABLED,
			OAuth2ScopeGrantModelImpl.FINDER_CACHE_ENABLED,
			OAuth2ScopeGrantImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByT",
			new String[] { String.class.getName() },
			OAuth2ScopeGrantModelImpl.OAUTH2TOKENID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_T = new FinderPath(OAuth2ScopeGrantModelImpl.ENTITY_CACHE_ENABLED,
			OAuth2ScopeGrantModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<OAuth2ScopeGrant> findByT(String oAuth2TokenId) {
		return findByT(oAuth2TokenId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<OAuth2ScopeGrant> findByT(String oAuth2TokenId, int start,
		int end) {
		return findByT(oAuth2TokenId, start, end, null);
	}
	...
	public List<OAuth2ScopeGrant> findByT(String oAuth2TokenId, int start,
		...
		return findByT(oAuth2TokenId, start, end, orderByComparator, true);
	}
	...
	public List<OAuth2ScopeGrant> findByT(String oAuth2TokenId, int start,
		...
		if (list == null) {
			...
			if (oAuth2TokenId == null) {
				query.append(_FINDER_COLUMN_T_OAUTH2TOKENID_1);
			}
			else if (oAuth2TokenId.equals("")) {
				query.append(_FINDER_COLUMN_T_OAUTH2TOKENID_3);
			}
			else {
				bindOAuth2TokenId = true;

				query.append(_FINDER_COLUMN_T_OAUTH2TOKENID_2);
			}
	 ...
	 */
	@Override
	public OAuth2ScopeGrant findByT_First(String oAuth2TokenId,
		OrderByComparator<OAuth2ScopeGrant> orderByComparator)
		throws NoSuchOAuth2ScopeGrantException {
		OAuth2ScopeGrant oAuth2ScopeGrant = fetchByT_First(oAuth2TokenId,
				orderByComparator);
	 ...
	 */
	@Override
	public OAuth2ScopeGrant fetchByT_First(String oAuth2TokenId,
		OrderByComparator<OAuth2ScopeGrant> orderByComparator) {
		List<OAuth2ScopeGrant> list = findByT(oAuth2TokenId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public OAuth2ScopeGrant findByT_Last(String oAuth2TokenId,
		OrderByComparator<OAuth2ScopeGrant> orderByComparator)
		throws NoSuchOAuth2ScopeGrantException {
		OAuth2ScopeGrant oAuth2ScopeGrant = fetchByT_Last(oAuth2TokenId,
				orderByComparator);
	 ...
	 */
	@Override
	public OAuth2ScopeGrant fetchByT_Last(String oAuth2TokenId,
		OrderByComparator<OAuth2ScopeGrant> orderByComparator) {
		int count = countByT(oAuth2TokenId);

		if (count == 0) {
			return null;
		}

		List<OAuth2ScopeGrant> list = findByT(oAuth2TokenId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public OAuth2ScopeGrant[] findByT_PrevAndNext(
		...
		try {
			...
			array[0] = getByT_PrevAndNext(session, oAuth2ScopeGrant,
					oAuth2TokenId, orderByComparator, true);

			array[1] = oAuth2ScopeGrant;

			array[2] = getByT_PrevAndNext(session, oAuth2ScopeGrant,
	...
	protected OAuth2ScopeGrant getByT_PrevAndNext(Session session,
	 ...
	 */
	@Override
	public void removeByT(String oAuth2TokenId) {
		for (OAuth2ScopeGrant oAuth2ScopeGrant : findByT(oAuth2TokenId,
	 ...
	 */
	@Override
	public int countByT(String oAuth2TokenId) {
	...
	private static final String _FINDER_COLUMN_T_OAUTH2TOKENID_1 = "oAuth2ScopeGrant.id.oAuth2TokenId IS NULL";
	private static final String _FINDER_COLUMN_T_OAUTH2TOKENID_2 = "oAuth2ScopeGrant.id.oAuth2TokenId = ?";
	private static final String _FINDER_COLUMN_T_OAUTH2TOKENID_3 = "(oAuth2ScopeGrant.id.oAuth2TokenId IS NULL OR oAuth2ScopeGrant.id.oAuth2TokenId = '')";
