...
AuthorizationModelHelper authorizationModelHelper = oAuth2ConnectedApplicationsPortletDisplayContext.getAuthorizationModelHelper();
%>
		...
		<aui:fieldset-group markupView="lexicon">
			<div class="panel-body">
				...
				<ul class="list-group">
					...
					<%
					for (String applicationName : authorizationModelHelper.getApplicationNames()) {
						String applicationScopeDescription = StringUtil.merge(authorizationModelHelper.getApplicationScopeDescription(applicationName), ", ");
					%>
						...
						<li class="list-group-item list-group-item-flex">
							...
							<div class="autofit-col autofit-col-expand">
								<h4 class="list-group-title text-truncate"><%= HtmlUtil.escape(authorizationModelHelper.getApplicationDescription(applicationName)) %></h4>
