...
<%
String adminEmailUserAddedBody = LocalizationUtil.getLocalizationXmlFromPreferences(portletPreferences, renderRequest, "adminEmailUserAddedBody", "preferences", null);
%>
