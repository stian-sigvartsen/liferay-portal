...
public interface SameSiteCookiesConfiguration {
	...
	@Meta.AD(deflt = "true", id = "enabled", name = "enabled", required = false)
	public boolean enabled();

	@Meta.AD(
		deflt = "true", description = "session-cookie-description",
		id = "sessionCookie", name = "session-cookie", required = false
	)
	public boolean sessionCookie();

	@Meta.AD(
		deflt = "", description = "cookie-names-description",
		id = "cookieNames", name = "cookie-names", required = false
	)
