...
public class EmailOTPEntryLocalServiceUtil {
	...
	public static
		com.liferay.multi.factor.authentication.checker.email.otp.model.
			EmailOTPEntry addEmailOTPEntry(String emailAddress, long userId)
				throws com.liferay.portal.kernel.exception.PortalException {

		return getService().addEmailOTPEntry(emailAddress, userId);
	}
	...
	public static java.util.List
		<com.liferay.multi.factor.authentication.checker.email.otp.model.
			EmailOTPEntry> getEmailOTPEntriesByUserId(
				long userId, int start, int end,
				com.liferay.portal.kernel.util.OrderByComparator
					<com.liferay.multi.factor.authentication.checker.email.otp.
						model.EmailOTPEntry> orderByComparator) {

		return getService().getEmailOTPEntriesByUserId(
	...
	public static boolean updateFailedAttempt(long userId, String userIP) {
		return getService().updateFailedAttempt(userId, userIP);
	}

	public static boolean updateSuccessAttempt(long userId, String userIP) {
		return getService().updateSuccessAttempt(userId, userIP);
	}
