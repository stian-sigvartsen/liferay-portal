...
public class EmailOTPEntryLocalServiceWrapper
	...
	public com.liferay.multi.factor.authentication.checker.email.otp.model.
		...
		return _emailOTPEntryLocalService.addEmailOTPEntry(
			emailAddress, userId);
	}
	...
	public java.util.List
		...
		return _emailOTPEntryLocalService.getEmailOTPEntriesByUserId(
	...
	public boolean updateFailedAttempt(long userId, String userIP) {
		return _emailOTPEntryLocalService.updateFailedAttempt(userId, userIP);
	}

	@Override
	public boolean updateSuccessAttempt(long userId, String userIP) {
		return _emailOTPEntryLocalService.updateSuccessAttempt(userId, userIP);
	}
