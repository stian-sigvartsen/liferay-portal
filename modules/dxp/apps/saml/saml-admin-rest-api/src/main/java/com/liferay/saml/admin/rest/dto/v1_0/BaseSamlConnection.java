...
@Generated("")
@GraphQLName(
	description = "Connection details for a connected SAML peer",
	value = "BaseSamlConnection"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "BaseSamlConnection")
public class BaseSamlConnection implements Serializable {

	public static BaseSamlConnection toDTO(String json) {
		return ObjectMapperUtil.readValue(BaseSamlConnection.class, json);
	}

	public static BaseSamlConnection unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(BaseSamlConnection.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof BaseSamlConnection)) {
			return false;
		}

		BaseSamlConnection baseSamlConnection = (BaseSamlConnection)object;

		return Objects.equals(toString(), baseSamlConnection.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.saml.admin.rest.dto.v1_0.BaseSamlConnection",
		name = "x-class-name"
	)
