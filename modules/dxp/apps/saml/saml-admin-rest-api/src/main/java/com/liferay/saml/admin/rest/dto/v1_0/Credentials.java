 ...
 */
@Generated("")
@GraphQLName(description = "TBC", value = "Credentials")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Credentials")
public class Credentials implements Serializable {

	public static Credentials toDTO(String json) {
		return ObjectMapperUtil.readValue(Credentials.class, json);
	}

	public static Credentials unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Credentials.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.saml.admin.rest.dto.v1_0.Credentials",
		name = "x-class-name"
	)
