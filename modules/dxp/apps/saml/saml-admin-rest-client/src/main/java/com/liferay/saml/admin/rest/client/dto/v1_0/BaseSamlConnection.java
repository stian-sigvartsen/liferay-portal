...
import com.liferay.saml.admin.rest.client.serdes.v1_0.BaseSamlConnectionSerDes;
 ...
 */
@Generated("")
public class BaseSamlConnection implements Cloneable, Serializable {

	public static BaseSamlConnection toDTO(String json) {
		return BaseSamlConnectionSerDes.toDTO(json);
	}
	...
	@Override
	public BaseSamlConnection clone() throws CloneNotSupportedException {
		return (BaseSamlConnection)super.clone();
	}
	...
	public String toString() {
		return BaseSamlConnectionSerDes.toJSON(this);
	}
