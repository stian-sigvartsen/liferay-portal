...
public interface MetadataResource {
	...
	public HttpInvoker.HttpResponse postIdpConnectionMetadataHttpResponse(
			Long idpConnectionId, Metadata metadata,
			Map<String, File> multipartFiles)
		throws Exception;

	public void postIdpConnectionMetadataBatch(
			Long idpConnectionId, Metadata metadata,
			Map<String, File> multipartFiles, String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postIdpConnectionMetadataBatchHttpResponse(
			Long idpConnectionId, Metadata metadata,
			Map<String, File> multipartFiles, String callbackURL, Object object)
		throws Exception;
	...
	public static class Builder {
		...
		public MetadataResource build() {
			return new MetadataResourceImpl(this);
		}
	...
	public static class MetadataResourceImpl implements MetadataResource {
		...
		public HttpInvoker.HttpResponse getIdpConnectionMetadataHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/saml-admin/v1.0/idpConnections/{idpConnectionId}/metadata");
		...
		public Metadata postIdpConnectionMetadata(
			...
			HttpInvoker.HttpResponse httpResponse =
				postIdpConnectionMetadataHttpResponse(
					idpConnectionId, metadata, multipartFiles);
		...
		public HttpInvoker.HttpResponse postIdpConnectionMetadataHttpResponse(
			...
			httpInvoker.part("metadata", MetadataSerDes.toJSON(metadata));
		...
		public void postIdpConnectionMetadataBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postIdpConnectionMetadataBatchHttpResponse(
					idpConnectionId, metadata, multipartFiles, callbackURL,
					object);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/saml-admin/v1.0/idpConnections/{idpConnectionId}/metadata/batch");
		...
		private MetadataResourceImpl(Builder builder) {
			_builder = builder;
		}
