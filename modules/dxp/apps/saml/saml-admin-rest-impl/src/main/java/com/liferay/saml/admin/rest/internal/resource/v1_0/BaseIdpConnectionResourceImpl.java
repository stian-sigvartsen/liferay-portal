...
public abstract class BaseIdpConnectionResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/saml-admin/v1.0/idpConnections'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrieves the connected SAML IDPs"
	)
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/idpConnections")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/saml-admin/v1.0/idpConnections/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@Override
	public Response postIdpConnectionBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				IdpConnection.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<java.util.Collection<IdpConnection>,
			 UnsafeConsumer<IdpConnection, Exception>, Exception>
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseIdpConnectionResourceImpl.class);
