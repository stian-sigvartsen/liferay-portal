...
public abstract class BaseMetadataResourceImpl
	implements EntityModelResource, MetadataResource,
			   VulcanBatchEngineTaskItemDelegate<Metadata> {
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<java.util.Collection<Metadata>,
			 UnsafeConsumer<Metadata, Exception>, Exception>
	...
	protected UnsafeBiConsumer
		<java.util.Collection<Metadata>, UnsafeConsumer<Metadata, Exception>,
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseMetadataResourceImpl.class);
