...
public class GoogleAuthorizationImpl implements GoogleAuthorization {
	...
	public GoogleAuthorizationCodeFlow getGoogleAuthorizationCodeFlow(
		...
		GoogleAuthorizationCodeFlow.Builder builder =
			new GoogleAuthorizationCodeFlow.Builder(
				...
				googleConfiguration.googleClientId(),
				googleConfiguration.googleClientSecret(), scopes);
	...
	public boolean isEnabled(long companyId) {
		...
		if (Validator.isNull(googleConfiguration.googleClientId()) ||
			Validator.isNull(googleConfiguration.googleClientSecret())) {
