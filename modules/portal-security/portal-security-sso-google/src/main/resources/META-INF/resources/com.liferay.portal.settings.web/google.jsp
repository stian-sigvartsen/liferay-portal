...
String googleClientId = googleAuthorizationConfiguration.googleClientId();
String googleClientSecret = googleAuthorizationConfiguration.googleClientSecret();
%>
...
<aui:fieldset>
	...
	<aui:input label="google-client-id" name="google--googleClientId" type="text" value="<%= googleClientId %>" wrapperCssClass="lfr-input-text-container" />

	<aui:input label="google-client-secret" name="google--googleClientSecret" type="text" value="<%= googleClientSecret %>" wrapperCssClass="lfr-input-text-container" />
</aui:fieldset>