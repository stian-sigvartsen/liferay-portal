...
@Component(
	    immediate = true,
	    property = {"key=portal.settings.authentication", "label=OpenID"},
	    service = DynamicInclude.class
	)
public class OpenidConfigurationDynamicInclude extends BaseDynamicInclude {
	...
	private static final String _JSP_PATH =
		"/META-INF/resources/html/portlet/portal_settings/authentication/open_id.jsp";

	private static final Log _log = LogFactoryUtil.getLog(
			OpenidConfigurationDynamicInclude.class);
